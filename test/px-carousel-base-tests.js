...
function runBaseTests() {
  px_carousel_1 = document.getElementById('px_carousel_1');

  suite('Base Automation Tests for px-carousel', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-carousel fixture is created', function() {
      assert.isTrue(document.getElementById('px_carousel_1') !== null);
    });
